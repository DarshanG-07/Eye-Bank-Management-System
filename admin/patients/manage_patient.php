    ...
    <form action="" id="patient-form">
        ...
        <div class="row">
			...
			<div class="form-group col-md-6">
                ...
                <input type="text" name="bloodgroup" id="bloodgroup" class="form-control form-control-border" placeholder="blood group" value ="<?php echo isset($bloodgroup) ? $bloodgroup : '' ?>" required>
            </div>
        </div>
    </form>
</div>
